...
| Python 多轮编排、API、工具、会话、安全策略与评分器 | Python Agent 主后端与 TypeScript 兼容语义一致 | 自动单元/API | `backend/tests/`（63 条） | existing / CI required |
...
CI 依次运行 Ruff、63 条 Pytest、ESLint、TypeScript、39 条 Vitest 和生产构建；不要求任何供应商密钥。
